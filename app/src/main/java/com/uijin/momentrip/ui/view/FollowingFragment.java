...
public class FollowingFragment extends Fragment {
    ...
    private void initUI(ViewGroup rootView) {
        ...
        follower_list = rootView.findViewById(R.id.friend_list);
        follower_list.setLayoutManager(new LinearLayoutManager(getContext(), LinearLayoutManager.VERTICAL, false));

        adapter = new FollowerAdapter();

        /** TODO: 팔로워 리스트 가져와서 설정 */
