...
public class FollowingAdapter extends RecyclerView.Adapter<FollowingAdapter.ViewHolder>{
    ...
    @Override
    public FollowingAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        // 뷰홀더 객체가 만들어질 때
        LayoutInflater inflater = LayoutInflater.from(viewGroup.getContext());
        View itemView = inflater.inflate(R.layout.item_friend, viewGroup, false);

        return new FollowingAdapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull FollowingAdapter.ViewHolder viewHolder, int position) {
        // 뷰홀더 객체가 바인딩될 때
